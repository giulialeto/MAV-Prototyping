...
def determine_optical_flow(prev_bgr, bgr, graphics= True):
    ...
    points_old = edge_detection_function.edge_detection(prev_bgr)
    points_new = edge_detection_function.edge_detection(bgr)
...
def show_flow(image_name_1, image_name_2,images):
